...
Public Class StockBalancesMain

    Private Sub StockBalancesMain_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'SAAEvoDataset.ItemBalances' table. You can move, or remove it, as needed.
        Me.CenterToScreen()
        Me.Top = 40
