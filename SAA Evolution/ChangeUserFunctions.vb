Public Class ChangeUserFunctions
    ...
    Dim allfunctions As New SAAEvoDatasetTableAdapters.FunctionTableAdapter
    Dim userfunctions As New SAAEvoDatasetTableAdapters.UserFunctionsTableAdapter
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        Dim query As New SAAEvoDatasetTableAdapters.UserFunctionsTableAdapter
