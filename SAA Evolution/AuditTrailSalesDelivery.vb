Public Class AuditTrailSalesDelivery
    ...
    Private Sub ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox1.SelectedIndexChanged
        Me.SalesOrderDetailTableAdapter.FillByAuditTrailUserDelivered(Me.SAAEvoDataset.SalesOrderDetail, ComboBox1.Text)
    End Sub

    Private Sub DateTimePicker2_ValueChanged(sender As Object, e As EventArgs) Handles DateTimePicker2.ValueChanged
        Me.SalesOrderDetailTableAdapter.FillByAuditTrailDateDelivered(Me.SAAEvoDataset.SalesOrderDetail, DateTimePicker1.Value, DateTimePicker2.Value)
    End Sub
